    ...
    function add1() {
        ...
        document.getElementById("addedtasks").innerHTML+=
            `<div id="${c}" class="tasks" >
                ...
                <div class="btn1"><button id="${c1}" style="background-color:green; border:black ;color:white" onClick="Completed(${c})">Completed</button></div>
                <div class="btn2"><button style="background-color:red; onClick="delfun(${c})">Delete</button></div>
            </div>`
            c=c+1;
